...
import com.xuesi.xuesisi.model.dto.userAnswer.UserAnswerEditRequest;
...
public class UserAnswerController {
    ...
    public BaseResponse<UserAnswerVO> addUserAnswer(@RequestBody UserAnswerAddRequest userAnswerAddRequest, HttpServletRequest request) {
        ...
        if (!ReviewStatusEnum.PASSED.equals(ReviewStatusEnum.getEnumByValue(questionBank.getReviewStatus()))) {
